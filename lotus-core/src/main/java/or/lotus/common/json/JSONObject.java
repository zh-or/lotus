...
public class JSONObject {
     ...
     * @return
     */
    public String toStringBySortKey(){

        JSONStringer stringer = new JSONStringer();
        try{
            stringer.object();
            Object[] keys = nameValuePairs.keySet().toArray();
            Arrays.sort(keys);
            for(Object key : keys){
                stringer.key(key.toString()).value(nameValuePairs.get(key));
            }
