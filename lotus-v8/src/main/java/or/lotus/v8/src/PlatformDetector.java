...
public class PlatformDetector {
    public static class Arch {
        public static String getName() {
            ...
            if (archName.equals(or.lotus.v8.src.Platform.UNKNOWN)) {
    ...
    public static class OS {
        public static String getName() {
            ...
            if (vendorName.contains("android") || osName.contains("android")) {
                return or.lotus.v8.src.Platform.ANDROID;
            }

            if (osName.equals(or.lotus.v8.src.Platform.UNKNOWN)) {
        ...
        public static boolean isWindows() {
            return getName().equals(or.lotus.v8.src.Platform.WINDOWS);
        }

        public static boolean isMac() {
            return getName().equals(or.lotus.v8.src.Platform.MACOSX);
        }

        public static boolean isLinux() {
            return getName().equals(or.lotus.v8.src.Platform.LINUX);
        }

        public static boolean isNativeClient() {
            return getName().equals(or.lotus.v8.src.Platform.NATIVE_CLIENT);
        }

        public static boolean isAndroid() {
            return getName().equals(or.lotus.v8.src.Platform.ANDROID);
        }
    ...
    private static String normalizeOs(String value) {
        ...
        if (value.startsWith("linux")) {
            return or.lotus.v8.src.Platform.LINUX;
        }
        if (value.startsWith("nacl")) {
            return or.lotus.v8.src.Platform.NATIVE_CLIENT;
        }
        if (value.startsWith("macosx") || value.startsWith("osx")) {
            return or.lotus.v8.src.Platform.MACOSX;
        }
        ...
        if (value.startsWith("windows")) {
            return or.lotus.v8.src.Platform.WINDOWS;
        }

        return or.lotus.v8.src.Platform.UNKNOWN;
    }
