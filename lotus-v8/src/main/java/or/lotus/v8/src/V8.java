...
import or.lotus.v8.src.JavaCallback;
import or.lotus.v8.src.JavaVoidCallback;
import or.lotus.v8.src.LibraryLoader;
import or.lotus.v8.src.ReferenceHandler;
import or.lotus.v8.src.Releasable;
import or.lotus.v8.src.SignatureProvider;
import or.lotus.v8.src.inspector.V8InspectorDelegate;
import or.lotus.v8.src.utils.V8Executor;
import or.lotus.v8.src.utils.V8Map;
import or.lotus.v8.src.utils.V8Runnable;
...
public class V8 extends V8Object {
    ...
    private or.lotus.v8.src.SignatureProvider signatureProvider       = null;
    private long                         objectReferences        = 0;
    private long                         v8RuntimePtr            = 0;
    private List<or.lotus.v8.src.Releasable>             resources               = null;
    ...
    private LinkedList<or.lotus.v8.src.ReferenceHandler> referenceHandlers       = new LinkedList<or.lotus.v8.src.ReferenceHandler>();
    ...
    private class MethodDescriptor {
        Object           object;
        Method           method;
        or.lotus.v8.src.JavaCallback callback;
        or.lotus.v8.src.JavaVoidCallback voidCallback;
        boolean          includeReceiver;
    }

    private synchronized static void load(final String tmpDirectory) {
        try {
            or.lotus.v8.src.LibraryLoader.loadLibrary(tmpDirectory);
     ...
     */
    public void addReferenceHandler(final or.lotus.v8.src.ReferenceHandler handler) {
     ...
     */
    public void removeReferenceHandler(final or.lotus.v8.src.ReferenceHandler handler) {
    ...
    private void notifyReferenceCreated(final V8Value object) {
        for (or.lotus.v8.src.ReferenceHandler referenceHandler : referenceHandlers) {
    ...
    private static void checkNativeLibraryLoaded() {
        if (!nativeLibraryLoaded) {
            String vendorName = or.lotus.v8.src.LibraryLoader.computeLibraryShortName(true);
            String baseName = or.lotus.v8.src.LibraryLoader.computeLibraryShortName(false);
    ...
    /*
     * (non-Javadoc)
     * @see or.lotus.v8.src.V8Value#close()
     */
    @Override
    public void close() {
        release(true);
    ...
    /*
     * (non-Javadoc)
     * @see or.lotus.v8.src.V8Value#release()
     */
    @Override
    @Deprecated
    public void release() {
    ...
    private void releaseResources() {
        if (resources != null) {
            for (or.lotus.v8.src.Releasable releasable : resources) {
                releasable.release();
            }
            resources.clear();
            resources = null;
     ...
     */
    public void registerResource(final or.lotus.v8.src.Releasable resource) {
        checkThread();
        if (resources == null) {
    ...
    void registerCallback(final or.lotus.v8.src.JavaCallback callback, final long objectHandle, final String jsFunctionName) {
