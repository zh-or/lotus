...
import or.lotus.v8.src.debug.*;
import or.lotus.v8.src.debug.BreakEvent;
import or.lotus.v8.src.debug.BreakHandler;
import or.lotus.v8.src.debug.CompileEvent;
...
public class DebugHandler implements Releasable {
    ...
    private List<or.lotus.v8.src.debug.BreakHandler> breakHandlers = new ArrayList<or.lotus.v8.src.debug.BreakHandler>();
     ...
     */
    public void addBreakHandler(final or.lotus.v8.src.debug.BreakHandler handler) {
     ...
     */
    public void removeBreakHandler(final or.lotus.v8.src.debug.BreakHandler handler) {
        runtime.getLocker().checkThread();
    ...
    private class BreakpointHandler implements JavaVoidCallback {
        ...
        public void invoke(final V8Object receiver, final V8Array parameters) {
            ...
            for (or.lotus.v8.src.debug.BreakHandler handler : breakHandlers) {
        ...
        private void invokeHandler(final V8Array parameters, final int event, final BreakHandler handler) {
            ...
            or.lotus.v8.src.debug.EventData typedEventData = null;
            try {
        ...
        private or.lotus.v8.src.debug.EventData createDebugEvent(final DebugEvent type, final V8Object eventData) {
            switch (type) {
                case Break:
                    return new BreakEvent(eventData);
                case BeforeCompile:
                    return new or.lotus.v8.src.debug.CompileEvent(eventData);
                case AfterCompile:
